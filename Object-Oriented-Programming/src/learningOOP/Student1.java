...
public class Student1 {
	...
	public Student1(String StudentID, String Fname, String Lname, String Email, double Subject1, double Subject2, double Subject3, double Average) 
	{	
		...
		Student1.Average =(Subject1+Subject2+Subject3)/3;
		
	}	
	
	public void Display(Student1 Students) 
	...
	public static void main(String[] args) {
		...
		Student1 Todd = new Student1("001", "Todd", "Hopkins", "Thop@gmail.org", 90.5, 80.0, 70.0,Average);
		
		Student1 Mario = new Student1("002", "Mario", "Wells", "Wario@gmail.org", 80.5, 100.0, 100.0,Average);
