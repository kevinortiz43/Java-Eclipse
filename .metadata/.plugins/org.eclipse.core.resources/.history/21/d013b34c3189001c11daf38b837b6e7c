...
public class HWCalculator {
	...
	static double num1,num2, sum, sub, div, mult;
	...
	public static void main(String[] args) {
		...
		switch (Selection) {
			case 1:
			sum = add(userNumber1, userNumber2);
			System.out.println("your result is "+sum);
			break;

			case 2:
			sub= subtract(userNumber1, userNumber2);
			System.out.println("your result is "+sub);
			break;
		
			case 3:
			mult = multiplication(userNumber1, userNumber2);
			System.out.println("your result is "+mult);
			break;
		
			case 4:
			div= division(userNumber1, userNumber2);
